...
%             lionSpeed=15;
            ...
            while distance>=4
                ...
                if i==1
                    ...
                    zeb_pos_f(i,1:2)=[zeb_pos_f(i-1,1)+zebraSpeed zeb_pos_f(i-1,2)];
                    zeb_pos_b(i,1:2)=[zeb_pos_b(i-1,1)+zebraSpeed zeb_pos_b(i-1,2)];
                    zeb_pos_c(i,1:2)=[zeb_pos_c(i-1,1)+zebraSpeed zeb_pos_c(i-1,2)];
